      ...
      <form action={formAction} className="flex flex-col justify-center gap-2">
        <div className="inline-flex gap-3">
          <input
            ...
            name="amount"
            required
            className="rounded-[0.4rem] withdraw-input w-8/12 text-black p-2 outline-none placeholder-opacity-70 placeholder-black bg-opacity-40 bg-primary-200"
          />
          <button
            id="btn-withdraw"
        ...
        <div id="withdraw-message" className="h-5">
          {state.success === false && (
